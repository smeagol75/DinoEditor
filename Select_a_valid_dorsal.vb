...
Public Class Select_a_valid_dorsal




    Private Sub Select_a_valid_dorsal_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load



        Label1.Text = "Number of " + Form1.ListBox1.SelectedItem
        Label2.Text = " for " + Form1.TextBox_team_name.Text
        If Form1.NumericDorsal.Value <> 0 Then
            NumericUpDown1.Value = Form1.NumericDorsal.Value
        End If
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        If Label3.Text = "FREE DORSAL" Then
            Form1.NumericDorsal.Value = NumericUpDown1.Value
            Me.Close()
        Else
