...
Public Class Select_a_team

    Private Sub Select_a_team_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        If ComboBox1.SelectedIndex = Form1.ListBox3.SelectedIndex Then
            MsgBox("Could not tranfer over same team!!!!")
        ElseIf MsgBox("Do you want To Tranfer to or Add: " & ComboBox1.SelectedItem.ToString, MsgBoxStyle.YesNo, "Add Team") = MsgBoxResult.Yes Then
            Db_Xbox_editor.Form1.combo1_selec_index = ComboBox1.SelectedIndex
            Db_Xbox_editor.Form1.combo1_selec_index_name = ComboBox1.SelectedItem
